...
`):t==="default"&&!e.overlay?["<stackline-loading",'  :visible="isLoading"',`  :options="${Ns(e,2)}"`,`  :style="{ minHeight: '220px' }"`,"/>"].join(`
`):["<section",`  v-stackline-loading="{ visible: isLoading, options: ${Ns(e,2,!0)} }"`,">",Km(t),"</section>"].join(`
`)}const Wm=jn({name:"VueLoadingDocsApp",props:{vueLine:{type:String,required:!0}},setup(e){const t=Pm(),r=nt([ya(`Vue ${e.vueLine} docs ready.`)]),n=Bm,i=fm.map(E=>({value:E.value,label:E.label})),s=nt("default"),l=nt("Copy code"),o=Kr({install:"Copy",plugin:"Copy",directive:"Copy",component:"Copy",overlay:"Copy",controller:"Copy"}),a=nt(!0),c=nt(!0),u=nt(!1),f=Kr({variant:"orbit",size:60,speed:900,color:"#2563eb",secondaryColor:"#c7d2fe",overlay:!1,fullscreen:!1,centered:!0,label:"Loading preview",delay:0,minVisible:240,reducedMotion:!1}),p=dr(()=>jm(f)),v=dr(()=>qm(f,s.value)),y=dr(()=>{const E=n.find(w=>w.id===s.value);return E?E.description:""}),b=dr(()=>({overlay:!0,centered:!0,variant:"glass-spinner",color:"#2563eb",secondaryColor:"#dbeafe",label:"Loading revenue card",minVisible:400})),P=dr(()=>({overlay:!0,centered:!0,variant:"liquid-pill",size:42,label:""}));function N(E){r.value=[ya(E),...r.value].slice(0,16)}async function _(){N("Showing fullscreen loader from createLoadingController.");const E=await t.show(document.body,{fullscreen:!0,overlay:!0,centered:!0,variant:"galaxy",color:"#38bdf8",secondaryColor:"#bfdbfe",minVisible:500,label:"Loading workspace"});window.setTimeout(()=>{E.hide().then(()=>{N("Fullscreen loader hidden.")})},1300)}function h(){c.value=!1,window.setTimeout(()=>{c.value=!0,N("Dashboard overlay replayed.")},40)}function m(){u.value=!0,N("Button loading state activated."),window.setTimeout(()=>{u.value=!1,N("Button loading state cleared.")},1200)}function C(){a.value=!1,window.setTimeout(()=>{a.value=!0},40)}async function A(){try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(v.value);else{const E=document.createElement("textarea");E.value=v.value,E.setAttribute("readonly","true"),E.style.position="absolute",E.style.left="-9999px",document.body.appendChild(E),E.select(),document.execCommand("copy"),document.body.removeChild(E)}l.value="Copied"}catch{l.value="Copy failed"}window.setTimeout(()=>{l.value="Copy code"},1200)}async function L(E,w){try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(w);else{const x=document.createElement("textarea");x.value=w,x.setAttribute("readonly","true"),x.style.position="absolute",x.style.left="-9999px",document.body.appendChild(x),x.select(),document.execCommand("copy"),document.body.removeChild(x)}o[E]="Copied"}catch{o[E]="Copy failed"}window.setTimeout(()=>{o[E]="Copy"},1200)}return{activeDescription:y,activeSurface:s,buttonOptions:P,buttonVisible:u,cardSurfaceOptions:b,componentCode:$m,controllerCode:zm,copyButtonLabel:l,copyCode:A,copySnippet:L,directiveCode:Fm,generatedCode:v,installCode:Dm,logs:r,overlayCode:Um,pluginCode:Vm,previewOptions:p,previewVisible:a,replayButtonSurface:m,replayCardSurface:h,replayTiming:C,runFullscreenDemo:_,state:f,snippetCopyLabels:o,surfaceVisible:c,surfaces:n,variants:i}}}),Gm={class:"app-shell"},Ym={class:"hero-grid"},Jm={class:"hero-card hero-main"},Xm={class:"badge"},Qm={class:"hero-card hero-setup"},Zm={class:"step"},eb={class:"code-block-shell is-compact"},tb={class:"code-block-head"},rb={class:"code-block compact"},nb={class:"step"},ib={class:"code-block-shell is-compact"},sb={class:"code-block-head"},lb={class:"code-block compact"},ob={class:"step"},ab={class:"code-block-shell is-compact"},cb={class:"code-block-head"},ub={class:"code-block compact"},fb={class:"playground-row"},db={class:"demo-card playground-card",id:"playground"},hb={class:"playground-shell"},pb={class:"playground-controls"},vb={class:"field"},gb=["value"],mb={class:"field"},bb={for:"playground-size"},yb={class:"field"},Sb={for:"playground-speed"},Cb={class:"field two-up"},wb={class:"field"},_b={class:"field two-up"},Tb={class:"toggle-row"},xb={class:"playground-actions"},Eb={class:"playground-preview"},kb={class:"playground-preview-tabs",role:"tablist","aria-label":"Preview surfaces"},Ab=["aria-selected","onClick"],Nb={class:"playground-description"},Ib={class:"modal-shell"},Ob={class:"modal-body"},Rb={class:"code-block code-preview"},Pb={class:"content-grid",id:"examples"},Mb={class:"examples-column"},Lb={class:"demo-card"},Db={class:"code-block-shell"},Vb={class:"code-block-head"},Fb={class:"code-block"},$b={class:"surface-frame"},Ub={class:"demo-card"},zb={class:"code-block-shell"},Bb={class:"code-block-head"},Hb={class:"code-block"},jb={class:"inline-actions"},Kb={class:"card-shell"},qb={class:"demo-card"},Wb={class:"button-surface"},Gb={class:"button-shell"},Yb={class:"demo-card"},Jb={class:"code-block-shell"},Xb={class:"code-block-head"},Qb={class:"code-block"},Zb={class:"inline-actions"},ey={class:"sidebar-column"},ty={class:"demo-card side-card"},ry={class:"event-log"};function ny(e,t,r,n,i,s){const l=Sc("stackline-loading"),o=wc("stackline-loading");return be(),Ne("div",Gm,[S("header",Ym,[S("section",Jm,[S("span",Xm,"Vue "+me(e.vueLine)+" · Loading wrapper",1),t[23]||(t[23]=Mr('<h1>@stackline/vue-loading</h1><p> Maintained Vue bindings for the Stackline loading toolkit. Keep the loading engine framework-agnostic, then add Vue-native ergonomics for declarative components, host directives, and fullscreen programmatic states. </p><div class="hero-actions"><a class="button primary" href="#playground">Open playground</a><a class="button secondary" href="https://github.com/alexandroit/vue-loading#readme" rel="noreferrer" target="_blank"> README </a></div><div class="hero-notes"><div><strong>Declarative</strong> Use a plain Vue component when the loader itself is what you want to render.</div><div><strong>Directive-ready</strong> Turn an existing card, table, chart shell, modal body, or upload zone into a loading surface.</div><div><strong>Programmatic</strong> Use a controller for fullscreen and workspace-level loading flows.</div></div>',4))]),S("section",Qm,[t[30]||(t[30]=S("h2",null,"Setup in 3 steps",-1)),S("div",Zm,[t[25]||(t[25]=S("span",null,"1",-1)),S("div",null,[t[24]||(t[24]=S("strong",null,"Install the wrapper",-1)),S("div",eb,[S("div",tb,[S("button",{type:"button",class:"ghost-button copy-button",onClick:t[0]||(t[0]=a=>e.copySnippet("install",e.installCode))},me(e.snippetCopyLabels.install),1)]),S("pre",rb,me(e.installCode),1)])])]),S("div",nb,[t[27]||(t[27]=S("span",null,"2",-1)),S("div",null,[t[26]||(t[26]=S("strong",null,"Register the plugin",-1)),S("div",ib,[S("div",sb,[S("button",{type:"button",class:"ghost-button copy-button",onClick:t[1]||(t[1]=a=>e.copySnippet("plugin",e.pluginCode))},me(e.snippetCopyLabels.plugin),1)]),S("pre",lb,me(e.pluginCode),1)])])]),S("div",ob,[t[29]||(t[29]=S("span",null,"3",-1)),S("div",null,[t[28]||(t[28]=S("strong",null,"Choose component, directive, or controller",-1)),S("div",ab,[S("div",cb,[S("button",{type:"button",class:"ghost-button copy-button",onClick:t[2]||(t[2]=a=>e.copySnippet("directive",e.directiveCode))},me(e.snippetCopyLabels.directive),1)]),S("pre",ub,me(e.directiveCode),1)])])])])]),S("div",fb,[S("section",db,[t[51]||(t[51]=S("div",{class:"demo-head"},[S("div",null,[S("h3",null,"Playground"),S("p",null,"Use the Vue wrapper against the same kind of interactive preview shell as the core docs.")])],-1)),S("div",hb,[S("form",pb,[S("div",vb,[t[31]||(t[31]=S("label",{for:"playground-variant"},"Variant",-1)),Ce(S("select",{id:"playground-variant","onUpdate:modelValue":t[3]||(t[3]=a=>e.state.variant=a)},[(be(!0),Ne(ye,null,gn(e.variants,a=>(be(),Ne("option",{key:a.value,value:a.value},me(a.label),9,gb))),128))],512),[[Tl,e.state.variant]])]),S("div",mb,[S("label",bb,[t[32]||(t[32]=Lt("Size ",-1)),S("span",null,me(e.state.size)+"px",1)]),Ce(S("input",{id:"playground-size","onUpdate:modelValue":t[4]||(t[4]=a=>e.state.size=a),type:"range",min:"18",max:"96"},null,512),[[vt,e.state.size,void 0,{number:!0}]])]),S("div",yb,[S("label",Sb,[t[33]||(t[33]=Lt("Speed ",-1)),S("span",null,me(e.state.speed)+"ms",1)]),Ce(S("input",{id:"playground-speed","onUpdate:modelValue":t[5]||(t[5]=a=>e.state.speed=a),type:"range",min:"300",max:"2200",step:"50"},null,512),[[vt,e.state.speed,void 0,{number:!0}]])]),S("div",Cb,[S("div",null,[t[34]||(t[34]=S("label",{for:"playground-color"},"Primary",-1)),Ce(S("input",{id:"playground-color","onUpdate:modelValue":t[6]||(t[6]=a=>e.state.color=a),type:"color"},null,512),[[vt,e.state.color]])]),S("div",null,[t[35]||(t[35]=S("label",{for:"playground-secondary-color"},"Secondary",-1)),Ce(S("input",{id:"playground-secondary-color","onUpdate:modelValue":t[7]||(t[7]=a=>e.state.secondaryColor=a),type:"color"},null,512),[[vt,e.state.secondaryColor]])])]),S("div",wb,[t[36]||(t[36]=S("label",{for:"playground-label"},"Label",-1)),Ce(S("input",{id:"playground-label","onUpdate:modelValue":t[8]||(t[8]=a=>e.state.label=a),type:"text"},null,512),[[vt,e.state.label]])]),S("div",_b,[S("div",null,[t[37]||(t[37]=S("label",{for:"playground-delay"},"Delay",-1)),Ce(S("input",{id:"playground-delay","onUpdate:modelValue":t[9]||(t[9]=a=>e.state.delay=a),type:"number",min:"0",step:"50"},null,512),[[vt,e.state.delay,void 0,{number:!0}]])]),S("div",null,[t[38]||(t[38]=S("label",{for:"playground-min-visible"},"Min visible",-1)),Ce(S("input",{id:"playground-min-visible","onUpdate:modelValue":t[10]||(t[10]=a=>e.state.minVisible=a),type:"number",min:"0",step:"50"},null,512),[[vt,e.state.minVisible,void 0,{number:!0}]])])]),S("div",Tb,[S("label",null,[Ce(S("input",{"onUpdate:modelValue":t[11]||(t[11]=a=>e.state.overlay=a),type:"checkbox"},null,512),[[hr,e.state.overlay]]),t[39]||(t[39]=Lt(" Overlay",-1))]),S("label",null,[Ce(S("input",{"onUpdate:modelValue":t[12]||(t[12]=a=>e.state.fullscreen=a),type:"checkbox"},null,512),[[hr,e.state.fullscreen]]),t[40]||(t[40]=Lt(" Fullscreen",-1))]),S("label",null,[Ce(S("input",{"onUpdate:modelValue":t[13]||(t[13]=a=>e.state.centered=a),type:"checkbox"},null,512),[[hr,e.state.centered]]),t[41]||(t[41]=Lt(" Centered",-1))]),S("label",null,[Ce(S("input",{"onUpdate:modelValue":t[14]||(t[14]=a=>e.state.reducedMotion=a),type:"checkbox"},null,512),[[hr,e.state.reducedMotion]]),t[42]||(t[42]=Lt(" Reduced motion",-1))])]),S("div",xb,[S("button",{type:"button",onClick:t[15]||(t[15]=(...a)=>e.replayTiming&&e.replayTiming(...a))},"Replay timing"),S("button",{type:"button",class:"ghost-button",onClick:t[16]||(t[16]=(...a)=>e.copyCode&&e.copyCode(...a))},me(e.copyButtonLabel),1)])]),S("div",Eb,[S("div",kb,[(be(!0),Ne(ye,null,gn(e.surfaces,a=>(be(),Ne("button",{key:a.id,type:"button",role:"tab",class:Ye(["playground-preview-tab",{"is-active":e.activeSurface===a.id}]),"aria-selected":e.activeSurface===a.id,onClick:c=>e.activeSurface=a.id},me(a.label),11,Ab))),128))]),S("p",Nb,me(e.activeDescription),1),S("div",{class:Ye(["playground-stage",{"is-reduced-motion":e.state.reducedMotion}])},[e.activeSurface==="default"&&!e.previewOptions.overlay?(be(),Ne("div",{key:0,class:Ye(["playground-surface","playground-surface--clean",{"is-fullscreen-simulated":e.state.fullscreen}])},[he(l,{visible:e.previewVisible,options:e.previewOptions,class:"playground-loader-host",style:tn({minHeight:e.state.fullscreen?"400px":"320px",width:"100%"})},null,8,["visible","options","style"])],2)):e.activeSurface==="table"?Ce((be(),Ne("div",{key:1,class:Ye(["playground-surface","surface-table",{"is-fullscreen-simulated":e.state.fullscreen}])},[t[44]||(t[44]=S("div",{class:"playground-table-head"},[S("span",null,"Status"),S("span",null,"Customer"),S("span",null,"Plan"),S("span",null,"MRR")],-1)),(be(),Ne(ye,null,gn(4,a=>S("div",{key:"table-"+a,class:"playground-table-row"},[...t[43]||(t[43]=[S("span",null,[S("i")],-1),S("span",null,[S("i")],-1),S("span",null,[S("i")],-1),S("span",null,[S("i")],-1)])])),64))],2)),[[o,{visible:e.previewVisible,options:e.previewOptions}]]):e.activeSurface==="page"?Ce((be(),Ne("div",{key:2,class:Ye(["playground-surface","surface-page",{"is-fullscreen-simulated":e.state.fullscreen}])},[...t[45]||(t[45]=[Mr('<div class="page-topbar"></div><div class="page-grid"><div class="page-tile"></div><div class="page-tile"></div><div class="page-tile"></div><div class="page-tile"></div></div>',2)])],2)),[[o,{visible:e.previewVisible,options:e.previewOptions}]]):e.activeSurface==="modal"?(be(),Ne("div",{key:3,class:Ye(["playground-surface","surface-modal",{"is-fullscreen-simulated":e.state.fullscreen}])},[S("div",Ib,[t[47]||(t[47]=S("div",{class:"modal-header"},null,-1)),Ce((be(),Ne("div",Ob,[...t[46]||(t[46]=[S("div",{class:"modal-line"},null,-1),S("div",{class:"modal-line short"},null,-1),S("div",{class:"modal-line"},null,-1)])])),[[o,{visible:e.previewVisible,options:e.previewOptions}]])])],2)):e.activeSurface==="chart"?Ce((be(),Ne("div",{key:4,class:Ye(["playground-surface","surface-chart",{"is-fullscreen-simulated":e.state.fullscreen}])},[...t[48]||(t[48]=[Mr('<div class="chart-bar" style="height:28%;"></div><div class="chart-bar" style="height:46%;"></div><div class="chart-bar" style="height:60%;"></div><div class="chart-bar" style="height:38%;"></div><div class="chart-bar" style="height:72%;"></div><div class="chart-bar" style="height:55%;"></div>',6)])],2)),[[o,{visible:e.previewVisible,options:e.previewOptions}]]):e.activeSurface==="upload"?Ce((be(),Ne("div",{key:5,class:Ye(["playground-surface","surface-upload",{"is-fullscreen-simulated":e.state.fullscreen}])},[...t[49]||(t[49]=[S("div",{class:"upload-icon"},null,-1),S("div",{class:"upload-title"},"Drop files here",-1),S("div",{class:"upload-caption"},"PNG, SVG, PDF up to 25 MB",-1)])],2)),[[o,{visible:e.previewVisible,options:e.previewOptions}]]):Ce((be(),Ne("div",{key:6,class:Ye(["playground-surface","surface-card-grid",{"is-fullscreen-simulated":e.state.fullscreen}])},[...t[50]||(t[50]=[S("div",{class:"surface-card-cell"},null,-1),S("div",{class:"surface-card-cell"},null,-1),S("div",{class:"surface-card-cell wide"},null,-1)])],2)),[[o,{visible:e.previewVisible,options:e.previewOptions}]])],2),S("pre",Rb,me(e.generatedCode),1)])])])]),S("main",Pb,[S("section",Mb,[S("section",Lb,[t[52]||(t[52]=S("div",{class:"demo-head"},[S("div",null,[S("h3",null,"Basic component"),S("p",null,"Use the Vue component when the loader itself is the thing being rendered in the tree.")])],-1)),S("div",Db,[S("div",Vb,[S("button",{type:"button",class:"ghost-button copy-button",onClick:t[17]||(t[17]=a=>e.copySnippet("component",e.componentCode))},me(e.snippetCopyLabels.component),1)]),S("pre",Fb,me(e.componentCode),1)]),S("div",$b,[he(l,{visible:"",options:{variant:"orbit",size:56,centered:!0,color:"#2563eb",secondaryColor:"#bfdbfe",label:"Loading dashboard"},class:"component-stage",style:{minHeight:"220px"}})])]),S("section",Ub,[t[54]||(t[54]=S("div",{class:"demo-head"},[S("div",null,[S("h3",null,"Directive overlay surface"),S("p",null,"Turn an existing card surface into a loading region without rebuilding the layout around the loader.")])],-1)),S("div",zb,[S("div",Bb,[S("button",{type:"button",class:"ghost-button copy-button",onClick:t[18]||(t[18]=a=>e.copySnippet("overlay",e.overlayCode))},me(e.snippetCopyLabels.overlay),1)]),S("pre",Hb,me(e.overlayCode),1)]),S("div",jb,[S("button",{type:"button",class:"button secondary",onClick:t[19]||(t[19]=(...a)=>e.replayCardSurface&&e.replayCardSurface(...a))},"Replay card loader")]),Ce((be(),Ne("div",Kb,[...t[53]||(t[53]=[Mr('<div class="card-metric">$128,400</div><div class="card-caption">Quarterly expansion pipeline</div><div class="card-bars"><span style="height:46%;"></span><span style="height:68%;"></span><span style="height:54%;"></span><span style="height:79%;"></span></div>',3)])])),[[o,{visible:e.surfaceVisible,options:e.cardSurfaceOptions}]])]),S("section",qb,[t[55]||(t[55]=S("div",{class:"demo-head"},[S("div",null,[S("h3",null,"Button and submit states"),S("p",null,"Use the same directive around a button surface when the request should stay anchored to the action.")])],-1)),S("div",Wb,[Ce((be(),Ne("div",Gb,[S("button",{type:"button",class:"cta-button",onClick:t[20]||(t[20]=(...a)=>e.replayButtonSurface&&e.replayButtonSurface(...a))},"Sync invoice")])),[[o,{visible:e.buttonVisible,options:e.buttonOptions}]])])]),S("section",Yb,[t[56]||(t[56]=S("div",{class:"demo-head"},[S("div",null,[S("h3",null,"Fullscreen and programmatic controller"),S("p",null,"Use a controller when the loading state is tied to navigation, bootstrapping, or a larger workspace transition.")])],-1)),S("div",Jb,[S("div",Xb,[S("button",{type:"button",class:"ghost-button copy-button",onClick:t[21]||(t[21]=a=>e.copySnippet("controller",e.controllerCode))},me(e.snippetCopyLabels.controller),1)]),S("pre",Qb,me(e.controllerCode),1)]),S("div",Zb,[S("button",{type:"button",class:"button primary",onClick:t[22]||(t[22]=(...a)=>e.runFullscreenDemo&&e.runFullscreenDemo(...a))},"Show fullscreen loader")])])]),S("aside",ey,[t[58]||(t[58]=Mr('<section class="demo-card side-card"><div class="demo-head"><div><h3>Wrapper surface</h3><p>The public API stays intentionally small so the real behavior continues to live in the core loading package.</p></div></div><ul class="feature-list"><li><code>&lt;stackline-loading /&gt;</code> for component-first loading states.</li><li><code>v-stackline-loading</code> for cards, tables, modals, charts, and buttons.</li><li><code>createLoadingController()</code> and <code>useLoading()</code> for fullscreen and programmatic flows.</li><li>Core exports like <code>loaderVariants</code>, <code>createLoader</code>, and theme helpers stay available.</li></ul></section><section class="demo-card side-card"><div class="demo-head"><div><h3>Release lines</h3><p>Each maintained runtime line gets its own docs build and npm release.</p></div></div><div class="release-links"><a href="../vue-2/">Vue 2</a><a href="../vue-3/">Vue 3</a></div></section>',2)),S("section",ty,[t[57]||(t[57]=S("div",{class:"demo-head"},[S("div",null,[S("h3",null,"Event log"),S("p",null,"Small runtime notes from the docs interactions while you test the wrapper.")])],-1)),S("div",ry,[(be(!0),Ne(ye,null,gn(e.logs,a=>(be(),Ne("div",{key:a,class:"log-line"},me(a),1))),128))])])])])])}const iy=Lm(Wm,[["render",ny]]);Pi(iy,{vueLine:"3.0.0 -> 3.5.32"}).use(Mm).mount("#app");

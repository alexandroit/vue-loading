...
`)}function Bf(e,t){return e.fullscreen?["import { createLoadingController } from '@revivejs/vue-loading';","","const loading = createLoadingController();","","async function showLoader() {",`  const instance = await loading.show(document.body, ${Ar(e,4,!0)});`,"  window.setTimeout(() => {","    void instance.hide();","  }, 1200);","}"].join(`

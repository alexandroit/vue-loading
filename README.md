# @revivejs/vue-loading

> A maintained Vue wrapper for **@revivejs/loading** with declarative components, host directives, a programmatic controller, and versioned demos for Vue 2 and Vue 3.

[![npm version](https://img.shields.io/npm/v/@revivejs/vue-loading.svg?style=flat-square)](https://www.npmjs.com/package/@revivejs/vue-loading)
[![npm downloads](https://img.shields.io/npm/dt/@revivejs/vue-loading.svg?style=flat-square)](https://www.npmjs.com/package/@revivejs/vue-loading)
[![npm monthly](https://img.shields.io/npm/dm/@revivejs/vue-loading.svg?style=flat-square)](https://www.npmjs.com/package/@revivejs/vue-loading)
[![license](https://img.shields.io/npm/l/@revivejs/vue-loading.svg?style=flat-square)](https://github.com/alexandroit/vue-loading/blob/main/LICENSE)
...
**[Documentation & Live Demos](https://alexandroit.github.io/vue-loading/)** | **[npm](https://www.npmjs.com/package/@revivejs/vue-loading)** | **[Issues](https://github.com/alexandroit/vue-loading/issues)** | **[Repository](https://github.com/alexandroit/vue-loading)**
...
`@revivejs/vue-loading` keeps the full ReviveJS loading engine intact while adapting it to modern Vue applications.
...
- polished loading variants from `@revivejs/loading`
...
| Package version | Vue version | Demo link |
| :---: | :---: | :--- |
| **3.0.0** | **3.5.x** | [Vue 3 demo](https://alexandroit.github.io/vue-loading/vue-3/) |
| **2.0.0** | **2.7.x** | [Vue 2 demo](https://alexandroit.github.io/vue-loading/vue-2/) |

## Installation

```bash
npm install @revivejs/vue-loading
```
